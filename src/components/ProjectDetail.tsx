...
export default function ProjectDetail() {
  ...
  if (!project) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-20 text-center">
        <h2 className="text-2xl font-bold text-zinc-900 mb-4">{t("project.not.found")}</h2>
        <Link to="/" className="text-zinc-500 hover:text-zinc-900 underline">{t("return.home")}</Link>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-[2.5rem] border-[3px] border-zinc-900 overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-colors duration-300">
        {/* Hero Section */}
        ...
        <div className="p-8 md:p-16 space-y-20">
          ...
          <section className="pb-12 border-b-4 border-zinc-900">
            <h2 className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] mb-8">{t("tech.stack")}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <section>
              ...
              <p className="text-zinc-600 leading-relaxed text-sm font-medium">
                {project.approach || t("default.approach")}
              </p>
            </section>
          </div>
